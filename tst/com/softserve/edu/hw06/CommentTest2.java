...
public class CommentTest2 {
    ...
    public void testComment() throws InterruptedException {
        ...
        js.executeScript("if(arguments[0].contentEditable === 'true') {arguments[0].innerText = 'qwertyui!@#$%^&amp;*()P1234567890'}", element);

        driver.findElement(By.cssSelector(".primary-global-button")).click();
        driver.findElement(By.cssSelector(".comment-body-wrapper")).click();
    }
}
