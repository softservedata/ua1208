...
public class UserName {
    ...
    public void UserName() throws InterruptedException {
        ...
        WebElement userNameField = driver.findElement(By.cssSelector(".author-name"));
        if (userNameField.getAttribute("disabled") != null) {
            System.out.println("The user name field is disabled.");
        } else {
            System.out.println("The user name field is enabled.");
