...
public class AvatarTest {
    ...
    public void ButtonTest03() throws InterruptedException {
        ...
        WebElement avatar = driver.findElement(By.cssSelector(".profile-avatar.comments-list.default-avatar.ng-star-inserted"));

        if (avatar.isDisplayed()) {
            System.out.println("Avatar is visible");
        } else {
            System.out.println("Avatar is not visible");
        }
        avatar.click();
